...
SUBSCRIPTION_TIERS = {
    config.STRIPE_FREE_TIER_ID: {'name': 'free', 'minutes': 60, 'cost': 5000},
    config.STRIPE_TIER_2_20_ID: {'name': 'tier_2_20', 'minutes': 120, 'cost': 1 + 5},  # 2 hours - TEMPORARY: Changed from $20 to $1 for testing
    ...
    config.STRIPE_TIER_2_20_YEARLY_ID: {'name': 'tier_2_20', 'minutes': 120, 'cost': 1 + 5},  # 2 hours/month - TEMPORARY: Changed from $20 to $1 for testing
    ...
    config.STRIPE_TIER_2_17_YEARLY_COMMITMENT_ID: {'name': 'tier_2_17_yearly_commitment', 'minutes': 120, 'cost': 1 + 5},  # 2 hours/month - TEMPORARY: Changed from $20 to $1 for testing
    ...
    'paypal_tier_2_20': {'name': 'tier_2_20', 'minutes': 120, 'cost': 1 + 5},  # 2 hours - TEMPORARY: Changed from $20 to $1 for testing
